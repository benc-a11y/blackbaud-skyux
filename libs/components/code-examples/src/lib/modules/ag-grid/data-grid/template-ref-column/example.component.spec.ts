...
describe('AG Grid data grid template ref column example', () => {
  ...
  it('should have grid options configured after init', () => {
    expect((component as any).gridOptions).toBeDefined();
    expect((component as any).gridOptions?.columnDefs).toBeDefined();
  });

  it('should have template refs defined', () => {
    expect((component as any).boldColumn).toBeDefined();
    expect((component as any).emphasizedColumn).toBeDefined();
  });
});
